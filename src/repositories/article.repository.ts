...
export class ArticleRepository extends Repository<ArticleItem> {
  constructor(Articles?: ArticleItem[]) {
  ...
  getAll(): Promise<ArticleItem[]> {
    return new Promise((res, rej) => res(this.members));
  }

  getById(id: number): Promise<ArticleItem | undefined> {
    return new Promise((res, rej) => res(this.members[0]));
  }

  create(Article: ArticleItem): Promise<boolean> {
    console.log("create:", Article);
    return new Promise((res, rej) => res(true));
  }

  update(id: number, Article: ArticleItem): Promise<boolean> {
